 ...
 * Auteur : JM CARTRON
 * Modification: Nicoas Esteve
 * Dernière mise à jour : 11/12/2014
 */
package reservation.classes;
...
public class Passerelle {
	...
	private static String _adresseHebergeur = "http://mrbs.livehost.fr/services/";
    ...
    // Méthode de classe pour confirmer une réservation (service ConfirmerReservations.php)
    public static String confirmerReservation(Utilisateur unUtilisateur, Reservation uneReservation){
    	...
    	try
    	{
    		...
    		parametresPostes.add(new BasicNameValuePair("nom", unUtilisateur.getName()));
    		parametresPostes.add(new BasicNameValuePair("mdp", unUtilisateur.getPassword()));
    		parametresPostes.add(new BasicNameValuePair("numreservation", Integer.toString(uneReservation.getId())));
    ...
    // Méthode de classe pour confirmer une réservation (service ConfirmerReservations.php)
    public static String confirmerReservation(String nomUtilisateur, String mdp, Reservation uneReservation){
    	String reponse = "";
    	try
    	{
    		// préparation des paramètres à poster vers le service web
    		ArrayList<NameValuePair> parametresPostes = new ArrayList<NameValuePair>();
    		parametresPostes.add(new BasicNameValuePair("nom", nomUtilisateur));
    		parametresPostes.add(new BasicNameValuePair("mdp", mdp));
    		parametresPostes.add(new BasicNameValuePair("numreservation", Integer.toString(uneReservation.getId())));
    ...
    // Méthode de classe pour annuler une réservation (service AnnulerReservations.php)
    public static String annulerReservation(Utilisateur unUtilisateur, Reservation uneReservation){
		String reponse = "";
    	try
    	{
    		// préparation des paramètres à poster vers le service web
    ...
    // Méthode pour changer son mot de passe ( service AnnulerReservation.php)
    public static String changerDeMdp(String nomUtilisateur, String mdp, String nouveauMdp, String confirmationMdp)
    {
		String reponse = "";
    	try
    	{
    		...
    		ArrayList<NameValuePair> parametresPostes = new ArrayList<NameValuePair>();
    		parametresPostes.add(new BasicNameValuePair("nom", nomUtilisateur));
    		parametresPostes.add(new BasicNameValuePair("ancienMdp", mdp));
    ...
    // Méthode pour demander de renouveller le mot de passe à un utilisateur
    ...
    public static String supprimerUtilisateur(String nomAdmin, String mdpAdmin, String nomUtilisateur){
    	String reponse = "";
    	try
    	{
    		// préparation des paramètres à poster vers le service web
    ...
    // Méthode pour tester le digicode d'une batiment
    ...
    // Méthode pour tester le digicode d'une salle
